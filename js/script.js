/**
 * @author Tushar <ttushar1512@gmail.com>
 */
(function ($) {
    "use strict";
...
var countDownDate = new Date("DEC 05, 2020 00:00:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "To celebrate the easiest Yes and shower the blessings!";
    }
}, 1000);
...
console.log('\n\n%c SAVE THE DATE: 05th Dec, 2021!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Tushar Tyagi', styles1, styles2);
